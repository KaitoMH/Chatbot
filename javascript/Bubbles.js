...
function Bubbles(container, self, options) {
  ...
  typeSpeed = options.typeSpeed || 3 // delay per character, to simulate the machine "typing"
  ...
  this.typeInput = function(callbackFn) {
    ...
    inputText.setAttribute("placeholder", "Type message...")
...
function prepHTML(options) {
  ...
  appendCSS(relative_path + "../css/input.css")
  appendCSS(relative_path + "../css/reply.css")
  appendCSS(relative_path + "../css/says.css")
  appendCSS(relative_path + "../css/setup.css")
  appendCSS(relative_path + "../css/typing.css")
}
